...
U_data = np.array([200, 200, 200, 200, 220, 220, 220, 220, 240, 240, 240, 240, 260, 260, 260, 280, 280, 280])  
I_data = np.array([3.58, 2.348, 1.733, 1.376, 3.8, 2.47, 1.825, 1.451, 3.942, 2.588, 1.91, 1.528, 2.7, 2, 1.6, 2.798, 2.07, 1.662]) 
L_data = np.array([0.04, 0.06, 0.08, 0.10, 0.04, 0.06, 0.08, 0.10, 0.04, 0.06, 0.08, 0.10, 0.06, 0.08, 0.10, 0.06, 0.08, 0.10]) 
