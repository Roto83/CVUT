##### Dobře naolejovaná špageta
Na rovné desce stolu leží špageta o celkové délce l, jejiž malý kousek o velikosti yo visí ze stolu dolů. Určete vývoj polohy koncového bodu špagety, pokud uvažujeme, že špageta je pokryta výběrovým olivovým olejem do té míry, že můžeme zanedbat veškeré tření. Pohyb začíná z klidu.
![[IMG_1287.jpeg]]

# Vzájemný pohyb soustav
Mějme dvě kartézské souřadnicové soustavy S a S':
- ﻿﻿Poloha hmotného bodu je popsána polohovým vektorem r v S a vektorem v r' v  
    S' (ostatní veličiny analogicky)
- ﻿﻿Rozdíl těchto polohových vektorů označíme R = r - r'
- ﻿﻿Jak bude vypadat pohybová rovnice hmotného bodu v S a S'?
Insert obrazek


- ﻿﻿Síly v obou soustavách jsou si rovny, pokud $\frac{d^{2}R}{dt^{2}}=0$ (tzn. vzájemný klid nebo vzájemný rovnoměrný přímočarý pohyb)
- ﻿﻿Lze snadno zobecnit: Všechny soustavy pohybující se rovnoměrně přímočaře vůči inerciální soustavě jsou také inerciální.

Galileiho princip relativity:
Všechny inerciální vztažné soustavy jsou pro popis mechanických dějů rovnocenné a žádnými mechanickými experimenty nelze změřit absolutní pohyb dané inerciální soustavy.
![[IMG_1288.jpeg]]
...
Samostudium:
- Detaily odvození obecné pohybové rovnice v neinerciální soustavě
- Bližší studium vlastností fiktivních sill
- Rozdíl mezi gravitačním a tíhovým zrychlením
- Věnujte se hezkým vizualizacím!